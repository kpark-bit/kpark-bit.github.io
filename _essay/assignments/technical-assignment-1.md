...
Yet this success rested on an assumption that the city was ecologically separate from the world beyond it. The challenge to that premise came from across the DMZ. During North Korea’s famine of the 1990s, its forests were rapidly stripped bare; degradation was particularly severe in North Hwanghae Province, across the border from northern Greater Seoul. The two photographs shown here capture hillsides that had turned to grassland. As their habitats disappeared, omnivorous raccoon dogs were driven south along waterways shared by the two Koreas. 

{% include essay/feature/image-gallery.html
   objectid="coll003;coll004" %}

In this way, rabies acquired a new vector and returned to the borderlands of northern Greater Seoul. The map shown here records the consequence. {% include essay/feature/aside.html
   objectid="coll005"
